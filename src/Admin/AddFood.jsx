...
function AddFood() {
  ...
  const validateForm = () => {
    ...
    if (!fooddata.fimg) newErrors.fimg = "Image upload is required.";
    setErrors(newErrors);
  ...
  const handleUpload = () => {
    ...
    formData.append("fimg", fooddata.fimg);

    axios
      .post("http://localhost:1234/food", formData, {
        headers: {
      ...
      .catch(() => {
        setIsloading(false);
        toast.error("Error uploading Food Data");
      });
  };
      ...
      <div className="flex flex-col items-center justify-center p-14">
        <div className="w-full max-w-5xl bg-white p-8 rounded-lg shadow-md border border-gray-300">
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-3xl font-bold text-red-600 ml-4">Add Food Data</h1>
          </div>
