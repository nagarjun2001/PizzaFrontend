...
function ManageStaff() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const staff = { staffName, username, password, email, role };
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  value={staffName}
                  onChange={(e) => setStaffName(e.target.value)}
                  className={`mt-1 p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 ${errors.staffName ? 'focus:ring-red-500 border-red-500' : 'focus:ring-indigo-500 border-gray-300'}`}
                />
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  value={username}
                  onChange={(e) => setUsername(e.target.value)}
                  className={`mt-1 p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 ${errors.username ? 'focus:ring-red-500 border-red-500' : 'focus:ring-indigo-500 border-gray-300'}`}
                />
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  className={`mt-1 p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 ${errors.email ? 'focus:ring-red-500 border-red-500' : 'focus:ring-indigo-500 border-gray-300'}`}
                />
              ...
              <div className="flex flex-col">
                ...
                <select
                  ...
                  value={role}
                  onChange={(e) => setRole(e.target.value)}
                  className={`mt-1 p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 ${errors.role ? 'focus:ring-red-500 border-red-500' : 'focus:ring-indigo-500 border-gray-300'}`}
                >
                  <option value="" disabled>Select a role</option>
                  <option value="Chef">Chef</option>
                  <option value="Delivery Boy">Delivery Boy</option>
